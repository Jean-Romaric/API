  ...
  try {
    const reponse = await fetch('https://data.education.gouv.fr/api/explore/v2.1/catalog/datasets/fr-en-annuaire-education/records?limit=25'); 
      console.log(reponse);
    ...
    const data = await reponse.json(); // Convertissez la réponse en JSON
